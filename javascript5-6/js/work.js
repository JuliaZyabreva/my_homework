...
/*Я объявляю две переменные для супер точного определения времени. Я буду их использовать в твоей функции selector(). Кстати прочитай вот эти рекомендации https://learn.javascript.ru/coding-style 
